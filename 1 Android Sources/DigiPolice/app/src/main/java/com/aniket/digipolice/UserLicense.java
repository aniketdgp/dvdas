...
public class UserLicense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SearchText =(EditText)findViewById(R.id.ed_search);
        ...
        final UserSession user = new UserSession(UserLicense.this);
        user_name = user.getUsername();


        //Setting Screen Name
        ScreenName.setText("Search User License");
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                search_username  = SearchText.getText().toString();
                System.out.println(search_username);
                //setting ViewLicense Function
                ViewLicense(search_username);
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finishAffinity();
                //Delete Session Data
                UserSession user =new UserSession(UserLicense.this);
                user.remove();
                Intent intent = new Intent(UserLicense.this, Login.class);
                startActivity(intent);
                Toast.makeText(UserLicense.this, "Log Out Successfully", Toast.LENGTH_LONG).show();
    ...
    public void ViewLicense(final String username){
       ...
       class ViewLicenseClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(UserLicense.this,"Getting User License",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(Output.equals("NoData")){
                    ...
                    ScreenName.setText("User Dosen't Exists");
                    ...
                    if(str_state.equals("Data Not Found")){
                        SCV.setVisibility(View.INVISIBLE);
                        ScreenName.setText("License Unverified");
                    }
                    else {
